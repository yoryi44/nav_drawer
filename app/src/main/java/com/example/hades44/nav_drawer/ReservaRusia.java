...
public class ReservaRusia extends AppCompatActivity implements Response.ErrorListener,Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reserva_rusia);
    ...
    public void cargarWebService()
    {
        String url="http://192.168.1.8:8080/SENA/QUINTO%20TRIMESTRE/ANDROID/ACTIVIDADES%20DE%20EVALUACION/ACTIVIDAD%204/reserva.php?pas="+pasajeros.getText().toString()+
                "&pag="+pago.getText().toString()+"&ini="+inicio.getText().toString()+"&reg="+regreso.getText().toString()+"&cor="+correo+"&dest=rusia";
